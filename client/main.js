...
////++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
engageScreenshareBtn = document.getElementById('screenShareBtnId')
engageScreenshareBtn.innerText = "Screen Share";
engageScreenshareBtn.addEventListener('click', screenShareController);

engageAudio = document.getElementById('audio');
engageAudio.innerText = "Mute";
engageAudio.addEventListener('click', audioController);

engageVideo = document.getElementById('video');
engageVideo.innerText = "Mute Video";
engageVideo.addEventListener('click', videoController);
...
function registerForEngageDigitalClientEvents() {
  ...
  engageDigitalClient.addEventHandler('connected', () => {
    ...
    var videoCont = document.getElementById("videoContainerhide");
    var subboxCont = document.getElementById("subbox");
    var login = document.getElementById("login");
    
    console.log("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
   // console.log(videoCont.style.display);
    if (videoCont.style.display === "none") {
  
      // Show the hidden element
      videoCont.style.display = "block";
      subboxCont.style.display = "block"
...
function audioController() {
  ...
  if (engageDigitalSession && !audio) {
    engageDigitalSession.enableAudio(true);
    engageAudio.innerText = "Mute";
    audio = true;
  }else if(engageDigitalSession && audio){
    engageDigitalSession.enableAudio(false); 
    engageAudio.innerText = "UnMute";
    audio = false;
  }
}
...
function videoController() {
  ...
  if (engageDigitalSession && !video) {
    engageDigitalSession.enableVideo(true);
    engageVideo.innerText = "Mute Video";
    video = true;
  }else if(engageDigitalSession && video){
    engageDigitalSession.enableVideo(false); 
    engageVideo.innerText = "UnMute Video";
    video = false;
  }
}
...
function screenShareController() {
  ...
  if (engageDigitalSession && !isScreenSharing) {
    ...
    engageScreenshareBtn.innerText = "Stop Sharing";
    isScreenSharing = true;
  }else if(engageDigitalSession && isScreenSharing){
...
function screenUnshareController() {
  if (engageDigitalSession && isScreenSharing) {
    engageDigitalSession.stopScreenShare();
  }
